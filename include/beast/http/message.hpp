...
struct request_headers
{
    ...
    */
    ...
    request_headers(request_headers&&) = default;
    request_headers(request_headers const&) = default;
    request_headers& operator=(request_headers&&) = default;
    request_headers& operator=(request_headers const&) = default;
    ...
    */
    template<class Arg1, class... ArgN,
        class = typename std::enable_if<
            sizeof...(ArgN) != 1 || ! std::is_convertible<
                request_headers, typename std::decay<
...
struct response_headers
{
    ...
    */
    ...
    response_headers(response_headers&&) = default;
    response_headers(response_headers const&) = default;
    response_headers& operator=(response_headers&&) = default;
    response_headers& operator=(response_headers const&) = default;
    ...
    */
    template<class Arg1, class... ArgN,
        class = typename std::enable_if<
            sizeof...(ArgN) != 1 || ! std::is_convertible<
                response_headers, typename std::decay<
                    Arg1>::type>::value>::type>
    explicit
